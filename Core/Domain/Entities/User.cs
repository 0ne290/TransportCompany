...
// В идеале было бы выделить всю логику по формированию пароля (формирование динамичной соли, статичную соль и алгоритмы соления и хеширования) в отдельный статичный класс
public class User
{
    public User()
    {
